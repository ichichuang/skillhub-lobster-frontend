    ...
    sections: [
      {
        title: '1. 适用范围',
        paragraphs: [
          '本政策适用于本服务网站、网页控制台、公开技能页面、登录流程、设备授权流程以及与这些能力相关的接口和服务。',
      ...
      },
      {
        ...
        bullets: [
          ...
          '使用与安全信息，例如 IP 地址、浏览器或设备信息、请求日志、下载记录、登录事件、API 令牌元数据、错误日志和审计日志。',
        ],
      },
      {
        title: '3. 我们如何使用信息',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '被撤销的 API 令牌将失效，但相关安全与审计记录可能继续保留。删除或下线技能后，备份、副本或日志中的相关信息可能在合理周期内继续存在。',
        ],
      },
      {
        title: '6. 你的选择与权利',
