...
export const SELECT_TRIGGER_CLASS_NAME = cn(
  'flex h-11 w-full items-center justify-between gap-2 rounded-lg border border-border bg-input px-4 py-2 text-sm text-foreground',
  ...
  'data-[placeholder]:text-placeholder [&>span]:line-clamp-1'
)

export const SELECT_CONTENT_CLASS_NAME = cn(
  'z-50 overflow-hidden rounded-lg border border-border bg-popover text-popover-foreground shadow-popover',
